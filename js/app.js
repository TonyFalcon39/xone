 ...
 */
    ...
    (() => {
        ...
        function tabs() {
            ...
            function setTabsAction(e) {
                ...
                if (el.closest("[data-tabs-title]")) {
                    ...
                    if (tabsBlock.classList.contains("_tab-spoller") && tabTitle.classList.contains("_tab-active")) {
        ...
        class Popside {
            constructor(options) {
                let config = {
                    logging: true,
                    init: true,
                    attributeOpenButton: "data-popside",
                    attributeCloseButton: "data-close",
                    fixElementSelector: "[data-lp]",
                    classes: {
                        popside: "popside",
                        popsideContent: "popside__body",
                        popsideActive: "popside_show",
                        bodyActive: "popside_show"
                    },
                    focusCatch: true,
                    closeEsc: true,
                    bodyLock: true,
                ...
                this.bodyLock = false;
                this.options.init ? this.initPopsides() : null;
            }
            initPopsides() {
                this.eventsPopside();
            }
            eventsPopside() {
                document.addEventListener("click", function(e) {
                    ...
                    const buttonClose = e.target.closest(`[${this.options.attributeCloseButton}]`);
                    if (buttonClose || !e.target.closest(`.${this.options.classes.popsideContent}`) && this.isOpen) {
                        e.preventDefault();
                        this.close();
                        return;
                    }
            ...
            open(selectorValue) {
                if (bodyLockStatus) {
                    ...
                    if (this.targetOpen.element) {
                        this.options.on.beforeOpen(this);
                        document.dispatchEvent(new CustomEvent("beforePopsideOpen", {
                            detail: {
                                popside: this
                            }
                        }));
                        this.targetOpen.element.classList.add(this.options.classes.popsideActive);
                        document.documentElement.classList.add(this.options.classes.bodyActive);
                        if (!this._reopen) !this.bodyLock ? bodyLock() : null; else this._reopen = false;
                        this.targetOpen.element.setAttribute("aria-hidden", "false");
                        this.previousOpen.selector = this.targetOpen.selector;
                        ...
                        this.options.on.afterOpen(this);
                        document.dispatchEvent(new CustomEvent("afterPopsideOpen", {
                            detail: {
                                popside: this
                            }
                        }));
            ...
            close(selectorValue) {
                ...
                if (!this.isOpen || !bodyLockStatus) return;
                this.options.on.beforeClose(this);
                document.dispatchEvent(new CustomEvent("beforePopsideClose", {
                    detail: {
                        popside: this
                    }
                }));
                if (this.targetOpen.element.hasAttribute(this.options.youtubeAttribute)) if (this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttribute}]`)) this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttribute}]`).innerHTML = "";
                this.previousOpen.element.classList.remove(this.options.classes.popsideActive);
                this.previousOpen.element.setAttribute("aria-hidden", "true");
                if (!this._reopen) {
                    document.documentElement.classList.remove(this.options.classes.bodyActive);
                    bodyUnlock();
                ...
                this.options.on.afterClose(this);
                document.dispatchEvent(new CustomEvent("afterPopsideClose", {
                    detail: {
                        popside: this
                    }
                }));
        ...
        flsModules.popside = new Popside({});
 ...
 */
        ...
        flsModules.tippy = tippy_esm(".withtippy", {
            placement: "left",
            delay: 300
        });
        flsModules.tippy = tippy_esm(".change-news__tolist", {
            placement: "top",
            delay: 0
        });
        ...
        function initSliders() {
            if (document.querySelector(".main__slider")) {
                ...
                function breakpointChecker() {
                    if (breakpoint.matches) {
                        thumbsSlider = new core(".thumbs__slider", {
                            modules: [ Navigation ],
                            observer: true,
                            observeParents: true,
                            slidesPerView: 3,
                        ...
                        if (void 0 !== thumbsSlider) thumbsSlider.destroy(true, true);
                        new core(".main__slider", {
                            modules: [ Navigation, Thumb, Autoplay ],
                            observer: true,
                            observeParents: true,
            ...
            if (document.querySelector(".smi__slider")) new core(".smi__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 10,
                ...
                loop: true,
                navigation: {
                    prevEl: ".smi__btn-prev",
                    nextEl: ".smi__btn-next",
                    disabledClass: "my-button-disabled"
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".popside-quickview__slider")) new core(".popside-quickview__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".popside-quickview__btn-prev",
                    nextEl: ".popside-quickview__btn-next",
                    disabledClass: "my-button-disabled"
                },
                on: {}
            });
            if (document.querySelector(".mainprod__slider")) {
                let thumbsProd = new core(".thumbprod__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".thumbprod__btn-prev",
                        nextEl: ".thumbprod__btn-next",
                        disabledClass: "my-button-disabled"
                    },
                    on: {}
                });
                new core(".mainprod__slider", {
                    ...
                    navigation: {
                        prevEl: ".mainprod__btn-prev",
                        nextEl: ".mainprod__btn-next",
                        disabledClass: "my-button-disabled"
                    },
                    on: {}
                });
            }
            if (document.querySelector(".similar-prod__slider")) new core(".similar-prod__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 10,
        ...
        setTimeout((() => {
            if (addWindowScrollEvent) {
                ...
                window.addEventListener("scroll", (function(e) {
                    ...
                    if (window.scrollY > 300) document.querySelector(".scrolltotop").classList.add("_active"); else document.querySelector(".scrolltotop").classList.remove("_active");
                }));
            }
        }), 0);
        /*!
...
***************************************************************************** */
        ...
        const galleryReviews = document.querySelector(".reviews__wrapper");
        const galleryProd = document.querySelector(".mainprod__wrapper");
        const gallerySert = document.querySelector(".sertificates-page__items");
        let galleyItems = [];
        if (galleryReviews) galleyItems.push({
            galleryReviews,
            galleryClass: lightgallery_es5(galleryReviews, {
        ...
        if (galleryProd) galleyItems.push({
            galleryReviews,
            galleryClass: lightgallery_es5(galleryProd, {
                plugins: [],
                mobileSettings: {
                    showCloseIcon: true
                },
        ...
        if (gallerySert) galleyItems.push({
            galleryReviews,
            galleryClass: lightgallery_es5(gallerySert, {
                plugins: [],
                mobileSettings: {
                    showCloseIcon: true
                },
 ...
 */
        ...
        findVideos();
        let searchHeaderBtn = document.querySelector(".search-header__btn");
        let searchHeaderForm = document.querySelector(".search-header__form");
        if (searchHeaderBtn) searchHeaderBtn.addEventListener("click", (function() {
            searchHeaderForm.classList.toggle("_active");
        }));
        let selectBrand = document.querySelector(".select-brand__item");
        let selectBrandBody = document.querySelector(".select-brand__body");
        window.onload = function() {
            if (selectBrand) {
                let selectBrandBodyHeight = selectBrandBody.offsetHeight;
                selectBrandBody.style.height = 0;
                selectBrandBody.style.paddingTop = 0;
                selectBrandBody.style.paddingBottom = 0;
                document.addEventListener("click", (function(e) {
                    if (e.target.closest(".select-brand")) if (selectBrand.classList.contains("_active")) {
                        selectBrand.classList.remove("_active");
                        selectBrandBody.style.height = 0;
                        selectBrandBody.style.paddingTop = 0;
                        selectBrandBody.style.paddingBottom = 0;
                    } else {
                        selectBrand.classList.add("_active");
                        selectBrandBody.style.height = selectBrandBodyHeight + "px";
                        selectBrandBody.style.paddingTop = 0 + "px";
                        selectBrandBody.style.paddingBottom = 0 + "px";
                    } else {
                        selectBrand.classList.remove("_active");
                        selectBrandBody.style.height = 0;
                        selectBrandBody.style.paddingTop = 0;
            ...
            let sidebarItem = document.querySelector(".catalog-sidebar__comp");
            if (sidebarItem) document.addEventListener("click", (function(e) {
                if (e.target.closest(".catalog-sidebar__arrow")) {
                    let catSideItem = e.target.closest(".catalog-sidebar__arrow").closest(".catalog-sidebar__item");
                    if (catSideItem.classList.contains("_active")) catSideItem.classList.remove("_active"); else catSideItem.classList.add("_active");
                }
            }));
            if (document.querySelector(".catmenu")) {
                let catMenu = document.querySelector(".catmenu");
                let catmenuBurger = catMenu.querySelector(".catmenu__burger");
                let catMenuItems = catMenu.querySelector(".page-top__categories");
                const breakpoint = window.matchMedia("(max-width:1200px)");
                let catMenuItemsHeight = catMenuItems.offsetHeight;
                function breakpointChecker() {
                    catmenuBurger.addEventListener("click", (function() {
                        if (breakpoint.matches) if (catMenu.classList.contains("_active")) {
                            catMenu.classList.remove("_active");
                            catMenuItems.style.height = 0;
                        } else {
                            catMenu.classList.add("_active");
                            catMenuItems.style.height = catMenuItemsHeight + "px";
                        }
                    }));
                    if (breakpoint.matches) {
                        catMenuItems.style.height = 0;
                        catMenuItems.style.overflow = "hidden";
                    } else {
                        if (catMenu.classList.contains("_active")) catMenu.classList.remove("_active");
                        catMenuItems.style.removeProperty("height");
                        catMenuItems.style.removeProperty("overflow");
                    }
                }
                breakpoint.addEventListener("change", breakpointChecker);
                breakpointChecker();
            }
            if (document.querySelector(".filters-catmob__btn")) {
                let catmobWrapper = document.querySelector(".filters-catmob__wrapper");
                document.addEventListener("click", (function(e) {
                    if (e.target.closest(".filters-catmob__btn")) catmobWrapper.classList.add("_active"); else if (catmobWrapper.classList.contains("_active")) catmobWrapper.classList.remove("_active");
                }));
            }
        };
        function initIsotopes() {
            const newsIso = document.querySelector(".news-page__items");
            if (newsIso) {
                new Isotope(newsIso, {
            ...
            const articlesIso = document.querySelector(".articles-page__items");
            if (articlesIso) {
                new Isotope(articlesIso, {
        ...
        if (document.querySelector(".reg-account")) {
            let regAccount = document.querySelector(".reg-account");
            let signAccount = document.querySelector(".sign-account");
            let btnEnter = document.querySelector(".acсount-page__btn--enter");
            let btnReg = document.querySelector(".acсount-page__btn--reg");
            btnEnter.addEventListener("click", (function() {
                btnReg.classList.add("_active");
                this.classList.remove("_active");
                signAccount.classList.add("_active");
                regAccount.classList.remove("_active");
            }));
            btnReg.addEventListener("click", (function() {
                this.classList.remove("_active");
                btnEnter.classList.add("_active");
                signAccount.classList.remove("_active");
                regAccount.classList.add("_active");
            }));
        }
        isWebp();
        addLoadedClass();
